export default {
  ...
  TERMINATION: {
    ...
    EXPLAIN_1:
      '1、提交解除合约前，请将USDT 和RED 账户可用资产全部转移，以免合约解除造成不必要的损失。',
    EXPLAIN_2:
    ...
    EXPLAIN_4:
      '4、用户如果在首次参与计划15天以内选择解除合约，平台将额外每单扣除30red作为合约违约金。',
    EXPLAIN_5:
