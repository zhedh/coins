...
import {formatDateTime, formatCoinPrice} from '../../utils/format'
            ...
            planList.map((planItem, key) => (
              ...
              >
                <div className="left-side">
                  ...
                  <li>{formatDateTime(planItem.addTime)}</li>
                </div>
                <span className="amount"> {formatCoinPrice(planItem.amount, 4)}</span>
              </ul>
            ))
          ) : (
            <NoData msg="暂无数据"/>
